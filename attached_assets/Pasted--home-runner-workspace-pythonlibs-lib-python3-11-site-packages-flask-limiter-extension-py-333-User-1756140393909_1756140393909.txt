...
[2025-08-25 16:46:25,833] INFO in unit_utils: BatchTrack startup
...
=== Reverting fallback_price column type ===
   ⚠️  fallback_price column does not exist - skipping
✅ Fallback price column type reversion completed
INFO  [alembic.runtime.migration] Running downgrade fix_unit_symbol_nullable -> b5c7d8e9f1a2, make unit symbol nullable for custom units
=== Restoring unit symbol as required ===
   ✅ Dropped ix_unit_symbol index
   ✅ Created ix_unit_name index
✅ Unit symbol downgrade completed
INFO  [alembic.runtime.migration] Running downgrade b5c7d8e9f1a2 -> 9a2b8c4d5e6f, replace billing provider booleans with enum fields
=== Restoring billing provider boolean columns ===
   ⚠️  Could not migrate data back: (psycopg2.errors.DatatypeMismatch) column "requires_stripe_billing" is of type boolean but expression is of type integer
LINE 3:                   requires_stripe_billing = CASE WHEN billin...
                                                    ^
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/replace_billing_booleans_with_enums.py", line 138, in downgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 115, in flush
    fn(*arg, **kw)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/ddl/impl.py", line 382, in drop_column
...
[SQL: ALTER TABLE subscription_tier DROP COLUMN tier_type]
