...
psycopg2.errors.DuplicateColumn: column "is_portioned" of relation "recipe" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20250925_01_add_portion_columns_to_recipe_and_batch.py", line 35, in upgrade
    safe_add_column('recipe', sa.Column('is_portioned', sa.Boolean(), nullable=True))
  File "/home/runner/workspace/migrations/versions/20250925_01_add_portion_columns_to_recipe_and_batch.py", line 18, in safe_add_column
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "is_portioned" of relation "recipe" already exists

[SQL: ALTER TABLE recipe ADD COLUMN is_portioned BOOLEAN]
