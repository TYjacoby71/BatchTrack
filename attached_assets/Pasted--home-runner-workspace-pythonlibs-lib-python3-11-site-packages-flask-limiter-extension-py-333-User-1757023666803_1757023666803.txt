...
Creating indexes on global_item...
Adding global_item_id column to inventory_item...
Creating index on inventory_item.global_item_id...
Adding foreign key constraint...
✅ Foreign key constraint added successfully
Adjusting inventory_item name constraints...
   Dropped old unique constraint on name
Adding performance indexes...
   ⚠️  Index may already exist: ix_inventory_item_organization_id
   ⚠️  Index may already exist: ix_inventory_item_type
   ⚠️  Index may already exist: ix_inventory_item_is_archived
Adding user.organization_id index...
   ⚠️  User organization index may already exist
...
[SQL: UPDATE alembic_version SET version_num='20250904_01' WHERE alembic_version.version_num = 'add_reference_guide_integration']
