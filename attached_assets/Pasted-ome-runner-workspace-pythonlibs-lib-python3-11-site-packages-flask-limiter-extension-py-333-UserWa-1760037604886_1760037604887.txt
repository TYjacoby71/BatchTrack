ome/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
...
category_id column already exists in product table
category_id column already exists in recipe table
Found existing Uncategorized category with ID: 7
...
Foreign key fk_product_category already exists
Index ix_product_category_id already exists
Set product.category_id to NOT NULL
Adding constraints to recipe table...
Foreign key fk_recipe_category already exists
Index ix_recipe_category_id already exists
...
psycopg2.errors.DuplicateColumn: column "portioning_data" of relation "recipe" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20250923_03_add_portioning_data_to_recipe_and_batch.py", line 22, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "portioning_data" of relation "recipe" already exists

[SQL: ALTER TABLE recipe ADD COLUMN portioning_data JSON]
