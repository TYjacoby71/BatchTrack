...
=== Adding consumables tables ===
   ✅ recipe_consumable table already exists - skipping
   ✅ batch_consumable table already exists - skipping
   ✅ extra_batch_consumable table already exists - skipping
...
Warning: Could not add organization_id to recipe_consumable: (psycopg2.errors.DuplicateColumn) column "organization_id" of relation "recipe_consumable" already exists

[SQL: ALTER TABLE recipe_consumable ADD COLUMN organization_id INTEGER]
...
[SQL: UPDATE alembic_version SET version_num='20250908_01' WHERE alembic_version.version_num = '2025090502']
