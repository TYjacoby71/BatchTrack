...
[2025-08-25 16:42:50,874] INFO in unit_utils: BatchTrack startup
...
psycopg2.errors.UndefinedObject: constraint "uq_subscription_tier_tier_key" of relation "subscription_tier" does not exist
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/add_tier_key_column.py", line 104, in downgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 115, in flush
    fn(*arg, **kw)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/ddl/impl.py", line 389, in drop_constraint
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.UndefinedObject) constraint "uq_subscription_tier_tier_key" of relation "subscription_tier" does not exist

[SQL: ALTER TABLE subscription_tier DROP CONSTRAINT uq_subscription_tier_tier_key]
