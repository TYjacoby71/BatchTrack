...
/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-08-18 18:35:06,862] INFO in unit_utils: BatchTrack startup
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/758a11548815_clean_subscription_tier_model_use_.py", line 34, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 443, in _create
    self._transfer_elements_to_new_table()
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 329, in _transfer_elements_to_new_table
    self._adjust_self_columns_for_partial_reordering()
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 314, in _adjust_self_columns_for_partial_reordering
    sorted_ = list(
              ^^^^^
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/util/topological.py", line 73, in sort
    for set_ in sort_as_subsets(tuples, allitems):
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/util/topological.py", line 47, in sort_as_subsets
    raise CircularDependencyError(
sqlalchemy.exc.CircularDependencyError: Circular dependency detected. ('stripe_lookup_key', 'fallback_price', 'whop_product_key', 'is_customer_facing', 'billing_provider', 'created_at', 'user_limit', 'is_billing_exempt', 'updated_at')