/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
Failed to register auth_bp from app.blueprints.auth.routes: cannot import name 'load_tiers_config' from 'app.blueprints.developer.subscription_tiers' (/home/runner/workspace/app/blueprints/developer/subscription_tiers.py)
Failed to register billing blueprint: cannot import name 'load_tiers_config' from 'app.blueprints.developer.subscription_tiers' (/home/runner/workspace/app/blueprints/developer/subscription_tiers.py)
[2025-08-15 17:19:33,288] INFO in unit_utils: BatchTrack startup
...
INFO  [alembic.runtime.migration] Running upgrade 57d6ce45a761 -> clean_subscription_tier_billing, clean subscription tier billing structure
...
sqlite3.OperationalError: duplicate column name: is_billing_exempt
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/clean_subscription_tier_billing.py", line 20, in upgrade
    op.add_column('subscription_tier', sa.Column('is_billing_exempt', sa.Boolean(), default=False))
  File "<string>", line 8, in add_column
  File "<string>", line 3, in add_column
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/ops.py", line 2157, in add_column
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/base.py", line 441, in invoke
    return fn(self, operation)
           ^^^^^^^^^^^^^^^^^^^
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/toimpl.py", line 170, in add_column
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.OperationalError: (sqlite3.OperationalError) duplicate column name: is_billing_exempt
[SQL: ALTER TABLE subscription_tier ADD COLUMN is_billing_exempt BOOLEAN]
