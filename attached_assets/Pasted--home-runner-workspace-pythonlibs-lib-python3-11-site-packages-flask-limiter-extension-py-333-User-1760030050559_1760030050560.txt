...
=== Creating missing tables ===
   ...
   ⚠️  pricing_snapshot table doesn't exist, skipping drop
   ⚠️  billing_snapshot table doesn't exist, skipping drop
...
psycopg2.errors.UndefinedColumn: column "created_at" of relation "batch" does not exist
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/edb302e17958_.py", line 104, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.UndefinedColumn) column "created_at" of relation "batch" does not exist

[SQL: ALTER TABLE batch DROP COLUMN created_at]
