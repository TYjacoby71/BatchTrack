...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20250904_01_global_items_and_indexes.py", line 54, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/ops.py", line 998, in create_index
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/base.py", line 441, in invoke
    return fn(self, operation)
           ^^^^^^^^^^^^^^^^^^^
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/toimpl.py", line 107, in create_index
    operations.impl.create_index(idx, **kw)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/ddl/postgresql.py", line 98, in create_index
...
[SQL: CREATE INDEX ix_inventory_item_name ON inventory_item (name)]
