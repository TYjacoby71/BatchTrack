...
Adding missing inventory_category_id column to inventory_item...
   ⚠️  Error adding column: (psycopg2.errors.UndefinedTable) relation "inventory_category" does not exist

[SQL: ALTER TABLE inventory_item ADD FOREIGN KEY(inventory_category_id) REFERENCES inventory_category (id)]
(Background on this error at: https://sqlalche.me/e/20/f405)
   ⚠️  Error creating index: (psycopg2.errors.InFailedSqlTransaction) current transaction is aborted, commands ignored until end of transaction block

[SQL: CREATE INDEX ix_inventory_item_inventory_category_id ON inventory_item (inventory_category_id)]
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/runtime/migration.py", line 630, in run_migrations
    head_maintainer.update_to_step(step)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/runtime/migration.py", line 862, in update_to_step
    self._update_version(from_, to_)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/runtime/migration.py", line 797, in _update_version
...
[SQL: UPDATE alembic_version SET version_num='20250904_04' WHERE alembic_version.version_num = '20250904_03']
(Background on this error at: https://sqlalche.me/e/20/2j85)
