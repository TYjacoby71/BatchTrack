...
❌ Product category seeding failed: name 'seed_product_categories' is not defined
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/click/core.py", line 794, in invoke
    return callback(*args, **kwargs)
           ^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/runner/workspace/app/management.py", line 285, in seed_product_categories_command
    seed_product_categories()
    ^^^^^^^^^^^^^^^^^^^^^^^
NameError: name 'seed_product_categories' is not defined. Did you mean: 'seed_product_categories_command'?