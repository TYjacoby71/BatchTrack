  ...
  File "/home/runner/workspace/migrations/versions/40edebb0ba0e_add_fs_uniquifier_to_user.py", line 61, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 450, in _create
    op_impl._exec(
...
sqlalchemy.exc.IntegrityError: (sqlite3.IntegrityError) NOT NULL constraint failed: _alembic_tmp_user.password
[SQL: INSERT INTO _alembic_tmp_user (id, username, first_name, last_name, email, phone, organization_id, created_at, user_type, timezone, deleted_at, deleted_by, is_deleted) SELECT user.id, user.username, user.first_name, user.last_name, user.email, user.phone, user.organization_id, user.created_at, user.user_type, user.timezone, user.deleted_at, user.deleted_by, user.is_deleted 
FROM user]
