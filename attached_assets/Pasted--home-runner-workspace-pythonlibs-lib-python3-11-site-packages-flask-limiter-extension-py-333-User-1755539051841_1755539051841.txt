/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-08-18 17:44:04,289] INFO in unit_utils: BatchTrack startup
...
INFO  [alembic.runtime.migration] Running upgrade clean_subscription_tier_billing -> e0c3f7e2036e, Clean SubscriptionTier model - use lookup keys only, remove hardcoded price IDs
...
sqlite3.OperationalError: no such table: _alembic_tmp_subscription_tier
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/e0c3f7e2036e_clean_subscriptiontier_model_use_lookup_.py", line 22, in upgrade
    op.drop_table('_alembic_tmp_subscription_tier')
  File "<string>", line 8, in drop_table
  File "<string>", line 3, in drop_table
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/ops.py", line 1421, in drop_table
    operations.invoke(op)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/base.py", line 441, in invoke
    return fn(self, operation)
           ^^^^^^^^^^^^^^^^^^^
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/toimpl.py", line 84, in drop_table
    operations.impl.drop_table(
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/ddl/impl.py", line 428, in drop_table
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.OperationalError: (sqlite3.OperationalError) no such table: _alembic_tmp_subscription_tier
[SQL: 
DROP TABLE _alembic_tmp_subscription_tier]
