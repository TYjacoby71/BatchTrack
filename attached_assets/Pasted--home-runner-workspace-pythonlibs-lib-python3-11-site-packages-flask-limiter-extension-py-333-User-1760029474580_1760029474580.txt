...
=== Adding missing User model columns ===
   ...
   ✅ Set is_deleted defaults for existing users
...
=== Creating missing tables ===
   ✅ developer_role_permission table already exists - skipping
   ✅ subscription_tier_permission table already exists - skipping
...
psycopg2.errors.UndefinedTable: table "pricing_snapshot" does not exist
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/edb302e17958_.py", line 88, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.UndefinedTable) table "pricing_snapshot" does not exist

[SQL: 
DROP TABLE pricing_snapshot]
