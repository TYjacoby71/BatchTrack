orkspace$ flask db upgrade
/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-08-13 20:40:29,069] INFO in unit_utils: BatchTrack startup
...
INFO  [alembic.runtime.migration] Running upgrade 6f9bc65166b3 -> a7c01b5be3dc, sync user_stats model with database schema
=== Syncing user_stats and other model changes ===
   Making organization_id nullable in batch_container
...
sqlite3.OperationalError: table _alembic_tmp_batch_container already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/a7c01b5be3dc_sync_user_stats_model_with_database_.py", line 57, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.OperationalError: (sqlite3.OperationalError) table _alembic_tmp_batch_container already exists
[SQL: 
CREATE TABLE _alembic_tmp_batch_container (
    id INTEGER NOT NULL, 
