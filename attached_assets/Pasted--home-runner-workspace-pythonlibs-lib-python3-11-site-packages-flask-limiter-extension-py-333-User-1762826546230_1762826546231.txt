/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-11-11 02:02:12,395] INFO in blueprints_registry: === Blueprint Registration Summary ===
Successful: 28
   - Authentication
   - Admin
   - Developer
...
[2025-11-11 02:02:12,395] INFO in __init__: 🔒 db.create_all() not enabled; Alembic migrations are the source of truth
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/env.py", line 194, in <module>
    run_migrations_online()
  File "/home/runner/workspace/migrations/env.py", line 188, in run_migrations_online
  ...
  File "/home/runner/workspace/migrations/versions/0005_cleanup_guardrails_0005_cleanup_guardrails.py", line 45, in upgrade
    safe_add_column('global_item', 'fatty_acid_profile', sa.JSON())
  File "/home/runner/workspace/migrations/postgres_helpers.py", line 172, in safe_add_column
