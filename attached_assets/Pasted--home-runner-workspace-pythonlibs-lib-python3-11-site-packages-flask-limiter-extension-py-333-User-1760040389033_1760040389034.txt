...
Column container_material already exists in inventory_item, skipping
...
Column container_color already exists in inventory_item, skipping
Added column container_closure_type to inventory_item
Added column container_shape to inventory_item
Column container_material already exists in global_item, skipping
...
Column container_color already exists in global_item, skipping
...
Processing inventory_item table...
  ℹ️  saponification_value already exists in inventory_item
  ℹ️  iodine_value already exists in inventory_item
  ℹ️  melting_point_c already exists in inventory_item
  ℹ️  flash_point_c already exists in inventory_item
  ℹ️  ph_value already exists in inventory_item
  ℹ️  moisture_content_percent already exists in inventory_item
  ℹ️  shelf_life_months already exists in inventory_item
  ℹ️  comedogenic_rating already exists in inventory_item
...
Processing global_item table...
  ℹ️  saponification_value already exists in global_item
  ℹ️  iodine_value already exists in global_item
  ℹ️  melting_point_c already exists in global_item
  ℹ️  flash_point_c already exists in global_item
  ℹ️  ph_value already exists in global_item
  ℹ️  moisture_content_percent already exists in global_item
  ℹ️  shelf_life_months already exists in global_item
  ℹ️  comedogenic_rating already exists in global_item
...
psycopg2.errors.DuplicateColumn: column "show_saponification_value" of relation "ingredient_category" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/env.py", line 147, in <module>
    run_migrations_online()
  File "/home/runner/workspace/migrations/env.py", line 141, in run_migrations_online
  ...
  File "/home/runner/workspace/migrations/versions/20250930_04_add_category_field_visibility.py", line 24, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 115, in flush
    fn(*arg, **kw)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/ddl/impl.py", line 373, in add_column
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "show_saponification_value" of relation "ingredient_category" already exists

[SQL: ALTER TABLE ingredient_category ADD COLUMN show_saponification_value BOOLEAN]
