/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-08-15 17:21:25,003] INFO in unit_utils: BatchTrack startup
...
sqlite3.OperationalError: table _alembic_tmp_subscription_tier already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/clean_subscription_tier_billing.py", line 36, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.OperationalError: (sqlite3.OperationalError) table _alembic_tmp_subscription_tier already exists
[SQL: 
CREATE TABLE _alembic_tmp_subscription_tier (
    ...
    billing_provider VARCHAR(32) DEFAULT 'exempt' NOT NULL, 
    tier_key VARCHAR(64), 
