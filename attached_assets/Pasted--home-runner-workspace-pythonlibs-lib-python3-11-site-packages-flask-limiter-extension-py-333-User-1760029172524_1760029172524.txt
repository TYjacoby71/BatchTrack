...
=== Adding missing last_login column ===
   ⚠️  last_login column already exists - migration skipped
✅ Migration completed
...
=== Adding missing User model columns ===
   ...
   ✅ deleted_by column already exists
   ✅ is_deleted column already exists
...
psycopg2.errors.DuplicateObject: constraint "fk_user_deleted_by_user" for relation "user" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/add_missing_user_columns.py", line 35, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/operations/batch.py", line 115, in flush
    fn(*arg, **kw)
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/alembic/ddl/impl.py", line 386, in add_constraint
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateObject) constraint "fk_user_deleted_by_user" for relation "user" already exists

[SQL: ALTER TABLE "user" ADD CONSTRAINT fk_user_deleted_by_user FOREIGN KEY(deleted_by) REFERENCES "user" (id)]
