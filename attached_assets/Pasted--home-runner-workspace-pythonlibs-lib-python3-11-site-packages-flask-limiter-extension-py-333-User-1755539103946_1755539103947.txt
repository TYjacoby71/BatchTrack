/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-08-18 17:44:44,153] INFO in unit_utils: BatchTrack startup
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/e0c3f7e2036e_clean_subscriptiontier_model_use_lookup_.py", line 54, in upgrade
    existing_type=sa.NullType(),
                  ^^^^^^^^^^^
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/__init__.py", line 294, in __getattr__
    raise AttributeError(f"module {__name__!r} has no attribute {name!r}")
AttributeError: module 'sqlalchemy' has no attribute 'NullType'. Did you mean: 'Nullable'?
