...
Column plan_snapshot already exists in batch, skipping
...
psycopg2.errors.DuplicateColumn: column "portion_unit_id" of relation "recipe" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20250925_03_add_portion_unit_fk.py", line 20, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "portion_unit_id" of relation "recipe" already exists

[SQL: ALTER TABLE recipe ADD COLUMN portion_unit_id INTEGER]
