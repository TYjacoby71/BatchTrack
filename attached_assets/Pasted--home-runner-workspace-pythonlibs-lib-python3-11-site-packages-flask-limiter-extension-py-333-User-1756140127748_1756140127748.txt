...
[2025-08-25 16:41:47,577] INFO in unit_utils: BatchTrack startup
...
psycopg2.errors.UndefinedColumn: column "stripe_price_id_yearly" of relation "subscription_tier" does not exist
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/39e309ff02d1_add_legacy_compatibility_fields_to_.py", line 79, in downgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.UndefinedColumn) column "stripe_price_id_yearly" of relation "subscription_tier" does not exist

[SQL: ALTER TABLE subscription_tier DROP COLUMN stripe_price_id_yearly]
