...
Column portion_unit_id already exists in recipe, skipping
Column portion_unit_id already exists in batch, skipping
...
psycopg2.errors.DuplicateColumn: column "container_material" of relation "inventory_item" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20250925_04_add_container_attributes.py", line 21, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "container_material" of relation "inventory_item" already exists

[SQL: ALTER TABLE inventory_item ADD COLUMN container_material VARCHAR(64)]
