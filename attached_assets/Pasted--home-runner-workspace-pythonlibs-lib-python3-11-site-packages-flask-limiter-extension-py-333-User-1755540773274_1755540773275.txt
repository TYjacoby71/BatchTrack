/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/flask_limiter/extension.py:333: UserWarning: Using the in-memory storage for tracking rate limits as no storage was explicitly specified. This is not recommended for production use. See: https://flask-limiter.readthedocs.io#configuring-a-storage-backend for documentation about configuring the storage backend.
  warnings.warn(
[2025-08-18 18:11:48,465] INFO in unit_utils: BatchTrack startup
...
sqlite3.OperationalError: table _alembic_tmp_organization already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/758a11548815_clean_subscription_tier_model_use_.py", line 21, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.OperationalError: (sqlite3.OperationalError) table _alembic_tmp_organization already exists
[SQL: 
CREATE TABLE _alembic_tmp_organization (
    id INTEGER NOT NULL, 
    ...
    offline_tier_cache JSON, 
    billing_status VARCHAR(50), 
    stripe_customer_id VARCHAR(255), 
    stripe_subscription_id VARCHAR(128), 
    whop_license_key VARCHAR(255), 
    whop_product_tier VARCHAR(32), 
    whop_verified BOOLEAN, 
    PRIMARY KEY (id), 
    FOREIGN KEY(subscription_tier_id) REFERENCES subscription_tier (id)
)
