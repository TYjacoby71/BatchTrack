...
ℹ️  addon table already exists
✅ Added allowed_addon_keys to subscription_tier
...
psycopg2.errors.DuplicateColumn: column "function_key" of relation "addon" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20251001_2_add_fields_to_addon.py", line 20, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "function_key" of relation "addon" already exists

[SQL: ALTER TABLE addon ADD COLUMN function_key VARCHAR(64)]
