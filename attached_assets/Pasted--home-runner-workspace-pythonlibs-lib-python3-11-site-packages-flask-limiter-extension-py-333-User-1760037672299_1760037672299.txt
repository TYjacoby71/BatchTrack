...
portioning_data column already exists in recipe table
portioning_data column already exists in batch table
...
psycopg2.errors.DuplicateColumn: column "sku_name_template" of relation "product_category" already exists
...
Traceback (most recent call last):
  ...
  File "/home/runner/workspace/migrations/versions/20250923_04_add_sku_name_template_to_product_category.py", line 21, in upgrade
  ...
  File "/home/runner/workspace/.pythonlibs/lib/python3.11/site-packages/sqlalchemy/engine/default.py", line 945, in do_execute
    cursor.execute(statement, parameters)
sqlalchemy.exc.ProgrammingError: (psycopg2.errors.DuplicateColumn) column "sku_name_template" of relation "product_category" already exists

[SQL: ALTER TABLE product_category ADD COLUMN sku_name_template VARCHAR(256)]
