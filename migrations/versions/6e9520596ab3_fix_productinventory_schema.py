"""Fix ProductInventory schema

Revision ID: 6e9520596ab3
Revises: add_organization_scoping
Create Date: 2025-06-25 19:52:56.532954
...
def upgrade():
    ...
    with op.batch_alter_table('product_inventory', schema=None) as batch_op:
        batch_op.add_column(sa.Column('variant', sa.String(length=128), nullable=False))
