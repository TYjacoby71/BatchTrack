...
Create Date: 2025-01-22 02:30:00.000000
...
def upgrade():
    ...
    # Now make required columns NOT NULL and add constraints (password stays nullable)
    with op.batch_alter_table('user', schema=None) as batch_op:
