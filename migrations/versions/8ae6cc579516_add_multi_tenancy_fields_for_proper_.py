...
Create Date: 2025-06-24 22:04:32.481321
...
def upgrade():
    ...
    with op.batch_alter_table('recipe', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_recipe_created_by', 'user', ['created_by'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('recipe', schema=None) as batch_op:
        batch_op.drop_constraint('fk_recipe_created_by', type_='foreignkey')
