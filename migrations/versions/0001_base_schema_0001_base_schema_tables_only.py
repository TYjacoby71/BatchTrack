...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    # Helper function for safely dropping indexes
    def safe_drop_index(index_name, table_name):
        ...
        if is_postgresql():
            ...
            try:
                ...
                print(f"   ℹ️  Index {index_name} does not exist or could not be dropped: {e}")

    # Safely drop indexes for unified_inventory_history
    safe_drop_index('ix_unified_history_org', 'unified_inventory_history')
    safe_drop_index(op.f('ix_unified_inventory_history_timestamp'), 'unified_inventory_history')
    safe_drop_index(op.f('ix_unified_inventory_history_inventory_item_id'), 'unified_inventory_history')
    safe_drop_index(op.f('ix_unified_inventory_history_expiration_date'), 'unified_inventory_history')
    safe_drop_index(op.f('ix_unified_inventory_history_change_type'), 'unified_inventory_history')
    safe_drop_index('idx_unified_item_timestamp', 'unified_inventory_history')
    safe_drop_index('idx_unified_item_remaining', 'unified_inventory_history')
    safe_drop_index('idx_unified_fifo_code', 'unified_inventory_history')
    safe_drop_index('idx_unified_expiration', 'unified_inventory_history')
    safe_drop_index('idx_unified_change_type', 'unified_inventory_history')

    op.drop_table('unified_inventory_history')
    op.drop_table('inventory_change_log')

    # Drop reservation table safely
    safe_drop_index('ix_reservation_order_id', 'reservation')
    safe_drop_index('idx_reserved_item_status', 'reservation')
    ...
    safe_drop_index(op.f('ix_inventory_item_organization_id'), 'inventory_item')
    safe_drop_index('ix_inventory_item_org', 'inventory_item')
    safe_drop_index(op.f('ix_inventory_item_name'), 'inventory_item')
