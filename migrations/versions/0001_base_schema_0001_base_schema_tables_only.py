...
def upgrade():
    ...
    sa.Column('smoke_point_c', sa.Float(), nullable=True),
    sa.Column('glass_transition_temp_c', sa.Float(), nullable=True),
    ...
    sa.Column('inci_name', sa.String(length=128), nullable=True),
    sa.Column('maximum_usage_percent', sa.Float(), nullable=True),
    sa.Column('allergen_info', sa.Text(), nullable=True),
    sa.Column('pregnancy_safe', sa.Boolean(), nullable=True),
    sa.Column('water_soluble', sa.Boolean(), nullable=True),
    sa.Column('oil_soluble', sa.Boolean(), nullable=True),
    sa.Column('alcohol_soluble', sa.Boolean(), nullable=True),
    sa.Column('emulsification_required', sa.Boolean(), nullable=True),
    sa.Column('refractive_index', sa.Float(), nullable=True),
    sa.Column('color_stability', sa.String(length=64), nullable=True),
    sa.Column('scent_strength', sa.Integer(), nullable=True),
    ...
    sa.Column('fair_trade_certified', sa.Boolean(), nullable=True),
