...
def upgrade():
    ...
    # Create reservation after batch exists
    ...
    # Create inventory_change_log after batch and inventory_lot exist
    ...
    # Defer inventory_history until after product_sku exists (FKs reference batch which now exists)
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('inventory_item_id', sa.Integer(), nullable=False),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('change_type', sa.String(length=50), nullable=True),
    ...
    # Ensure reservation created after batch
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('order_id', sa.String(length=128), nullable=False),
    sa.Column('reservation_id', sa.String(length=128), nullable=True),
    sa.Column('product_item_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    with op.batch_alter_table('unified_inventory_history', schema=None) as batch_op:
        ...
        batch_op.drop_index('idx_unified_item_timestamp')
        batch_op.drop_index('idx_unified_item_remaining')
        batch_op.drop_index('idx_unified_fifo_code')
        batch_op.drop_index('idx_unified_expiration')
        batch_op.drop_index('idx_unified_change_type')
    ...
    with op.batch_alter_table('inventory_item', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_inventory_item_ownership'))
        ...
        batch_op.drop_index('ix_inventory_item_is_archived')
        batch_op.drop_index(batch_op.f('ix_inventory_item_global_item_id'))
    ...
    with op.batch_alter_table('global_item', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_global_item_name'))
        batch_op.drop_index(batch_op.f('ix_global_item_item_type'))
    ...
    with op.batch_alter_table('domain_event', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_domain_event_occurred_at'))
        batch_op.drop_index(batch_op.f('ix_domain_event_is_processed'))
        batch_op.drop_index(batch_op.f('ix_domain_event_event_name'))
        batch_op.drop_index(batch_op.f('ix_domain_event_entity_type'))
        batch_op.drop_index(batch_op.f('ix_domain_event_entity_id'))
        batch_op.drop_index(batch_op.f('ix_domain_event_correlation_id'))
