...
Create Date: 2025-05-21 15:35:03.447523
...
def upgrade():
    ...
    with op.batch_alter_table('inventory_history', schema=None) as batch_op:
        batch_op.drop_constraint('fk_inventory_history_source_fifo_id_inventory_history', type_='foreignkey')
        batch_op.drop_constraint('fk_inventory_history_credited_to_fifo_id_inventory_history', type_='foreignkey')
...
def downgrade():
    ...
    with op.batch_alter_table('inventory_history', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_inventory_history_source_fifo_id_inventory_history', 'inventory_history', ['source_fifo_id'], ['id'])
        batch_op.create_foreign_key('fk_inventory_history_credited_to_fifo_id_inventory_history', 'inventory_history', ['credited_to_fifo_id'], ['id'])
