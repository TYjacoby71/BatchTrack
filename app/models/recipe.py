...
class Recipe(ScopedModelMixin, db.Model):
    ...
    parent_recipe_id = db.Column(db.Integer, db.ForeignKey('recipe.id'), nullable=True, index=True)
    cloned_from_id = db.Column(db.Integer, db.ForeignKey('recipe.id'), nullable=True, index=True)
    root_recipe_id = db.Column(db.Integer, db.ForeignKey('recipe.id'), nullable=True, index=True)
