...
class Addon(db.Model):
    ...
    billing_type = db.Column(
        db.String(32), nullable=False, default="subscription"
...
class OrganizationAddon(db.Model):
    ...
    addon_id = db.Column(
        db.Integer, db.ForeignKey("addon.id"), nullable=False, index=True
    )

    active = db.Column(db.Boolean, default=True, nullable=False)
    source = db.Column(
        db.String(32), nullable=False, default="subscription_item"
    )  # subscription_item | one_time
