...
class UserRoleAssignment(db.Model):
    ...
    developer_role_id = db.Column(
        db.Integer, db.ForeignKey("developer_role.id"), nullable=True
    )  # Developer role
    ...
    developer_role = db.relationship(
        "DeveloperRole", backref="user_assignments"
    )  # Developer role
