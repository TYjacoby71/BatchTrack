...
developer_role_permission = db.Table(
    "developer_role_permission",
    db.Column(
        "developer_role_id",
        db.Integer,
        db.ForeignKey("developer_role.id"),
        primary_key=True,
    ),
    db.Column(
        "developer_permission_id",
        db.Integer,
        db.ForeignKey("developer_permission.id"),
        primary_key=True,
    ),
)
...
class DeveloperRole(db.Model):
    ...
    category = db.Column(
        db.String(32), default="developer"
    ...
    def has_permission(self, permission_name):
        ...
        return any(
            perm.name == permission_name for perm in self.permissions if perm.is_active
        )
