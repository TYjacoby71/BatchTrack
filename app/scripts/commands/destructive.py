    ...
    try:
        ...
        for table in organization_tables:
            ...
            try:
                ...
                logger.warning(
                    "Suppressed exception fallback at app/scripts/commands/destructive.py:115",
                    exc_info=True,
                )
        ...
        logger.warning(
            "Suppressed exception fallback at app/scripts/commands/destructive.py:133",
            exc_info=True,
        )
...
def clear_dev_users_command():
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/scripts/commands/destructive.py:187",
            exc_info=True,
        )
    ...
    try:
        ...
        for table in organization_tables:
            ...
            try:
                ...
                logger.warning(
                    "Suppressed exception fallback at app/scripts/commands/destructive.py:301",
                    exc_info=True,
                )
                print(f"   ⚠️  Could not clear {table}: {table_error}")
        ...
        for table, columns in user_reference_tables:
            try:
                ...
                logger.warning(
                    "Suppressed exception fallback at app/scripts/commands/destructive.py:340",
                    exc_info=True,
                )
                print(
        ...
        logger.warning(
            "Suppressed exception fallback at app/scripts/commands/destructive.py:360",
            exc_info=True,
        )
        db.session.rollback()
