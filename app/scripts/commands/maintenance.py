...
def update_permissions_command():
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/scripts/commands/maintenance.py:27",
            exc_info=True,
        )
...
def update_addons_command():
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/scripts/commands/maintenance.py:50",
            exc_info=True,
        )
...
def update_subscription_tiers_command():
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/scripts/commands/maintenance.py:69",
            exc_info=True,
        )
