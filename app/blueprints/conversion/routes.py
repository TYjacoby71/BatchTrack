    ...
    if request.method == 'POST':
        try:
            ...
            if custom_unit_obj.unit_type != comparable_unit_obj.unit_type:
                ...
                if {'volume', 'weight'} <= {custom_unit_obj.unit_type, comparable_unit_obj.unit_type}:
                    pass  # This is allowed
                # Allow count ↔ volume/weight for custom units (user-defined relationships)
                elif custom_unit_obj.unit_type == 'count' and comparable_unit_obj.unit_type in ['volume', 'weight']:
                    pass  # This is allowed - user knows their apple size
                elif comparable_unit_obj.unit_type == 'count' and custom_unit_obj.unit_type in ['volume', 'weight']:
