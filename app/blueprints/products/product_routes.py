...
```
werkzeug.routing.exceptions.BuildError: Could not build url for endpoint 'products.product_list'. Did you mean 'expiration.api_product_status' instead?
```

The error indicates that the endpoint name 'product.view_product' is not correct in the url_for calls. It should be 'products.view_product' to match the blueprint name. I'll update the url_for calls.
