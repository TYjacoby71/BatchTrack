    ...
    rate_limiters = [
        {
            ...
            "notes": "Per-user login cap; tuned for Locust 5k-user spikes.",
        },
        {
        ...
        },
        {
            ...
            "source": "app/routes/app_routes.py::dashboard",
            "notes": "Main authenticated dashboard; capped per user/session.",
        },
        {
            "endpoint": "GET /auth-check",
            "limit": "500 per minute",
            "source": "app/routes/app_routes.py::auth_check",
            "notes": "Lightweight heartbeat endpoint consumed by the SPA shell.",
        },
        {
            "endpoint": "GET /tools",
            "limit": "60000/hour;5000/minute",
            "source": "app/routes/tools_routes.py::tools_index",
            "notes": "Public calculator tools landing (SEO-heavy).",
        },
        {
        ...
        {
            "endpoint": "GLOBAL DEFAULT (no override)",
            "limit": "5000 per hour;1000 per minute",
            "source": "app/config.py::BaseConfig.RATELIMIT_DEFAULT",
            "notes": "Applies whenever no decorator is set (per user when authenticated, else per IP).",
        },
    ]
