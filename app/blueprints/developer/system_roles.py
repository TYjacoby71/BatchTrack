...
def create_system_role():
    ...
    try:
        ...
        if existing_role:
            return jsonify(
                {"success": False, "error": "System role with this name already exists"}
            )
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:75",
            exc_info=True,
        )
        db.session.rollback()
...
def update_system_role(role_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:130",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def delete_system_role(role_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:153",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def create_developer_role():
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:199",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def update_developer_role(role_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:254",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def delete_developer_role(role_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:276",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def create_developer_user():
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:337",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def update_developer_user_role(user_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:385",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
...
def get_developer_user_role(user_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:408",
            exc_info=True,
        )
        return jsonify({"success": False, "error": str(e)})
...
def delete_developer_user(user_id):
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/blueprints/developer/system_roles.py:435",
            exc_info=True,
        )
        db.session.rollback()
        return jsonify({"success": False, "error": str(e)})
