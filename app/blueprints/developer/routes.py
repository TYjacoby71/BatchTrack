...
def integrations_checklist():
    ...
    launch_env_sections = [
        ...
        },
        {
            ...
            'section_items': [
                _make_item('LOCUST_BOOTSTRAP_DATA', 'When true, Locust auto-creates a fresh load-test org + users and seeds data before running.', required=False, recommended='0 / unset', note='Set to 1 for staging smoke tests that need disposable data each run. Overwrites the mutation accounts file.'),
                ...
                _make_item('LOCUST_MUTATION_ACCOUNTS_FILE', 'Path to the JSON file storing the staged load-test accounts.', required=False, recommended='loadtests/_generated_accounts.json', note='Override only if you need to keep multiple account pools.'),
