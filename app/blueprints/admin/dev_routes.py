...
def organizations():
    ...
    return render_template('admin/dev_organizations.html', 
                         organizations=organizations,
                         selected_org=selected_org)

@dev_bp.route('/select-org/<int:org_id>')
@login_required
...
@dev_bp.route('/api/organizations')
@login_required
