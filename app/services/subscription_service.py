...
class SubscriptionService:
    ...
    # Trial Management Methods (consolidated from trial_management.py)
    @staticmethod
        ...
        for org in expired_orgs:
            try:
                if org.billing_info and org.stripe_customer_id:
                    ...
                    SubscriptionService._convert_to_paid(org)
                else:
                    # Suspend organization for missing billing
                    SubscriptionService._suspend_for_billing(org)
    ...
    def _convert_to_paid(organization):
        ...
        SubscriptionService._send_conversion_email(organization, success=True)
    ...
    def _suspend_for_billing(organization):
        ...
        SubscriptionService._send_conversion_email(organization, success=False)
