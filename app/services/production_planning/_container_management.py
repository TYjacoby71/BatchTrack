...
Handles container selection, fill strategy analysis, and optimization logic.
Consolidates all the complex container logic that was scattered across multiple files.
"""
...
def calculate_container_fill_strategy(containers: List[dict], yield_amount: float) -> dict:
    """Calculate fill strategy for given containers - utility function"""
    # Implementation for calculating fill strategies
    # This would contain the complex container fill logic
    pass
