...
def _extract_lines_from_recipe(recipe) -> Dict[str, List[Dict[str, Any]]]:
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/services/exports.py:22", exc_info=True
        )
        ings = []
    try:
        cons = [
        ...
        logger.warning(
            "Suppressed exception fallback at app/services/exports.py:37", exc_info=True
        )
        cons = []
...
class ExportService:
    ...
    def _html_to_pdf(html: str) -> bytes:
        ...
        try:
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/exports.py:207",
                exc_info=True,
            )
            pass
