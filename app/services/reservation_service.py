...
class ReservationService:
    ...
    def release_reservation(order_id):
        ...
        try:
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/reservation_service.py:157",
                exc_info=True,
            )
            db.session.rollback()
    ...
    def cancel_reservation(reservation_id):
        ...
        try:
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/reservation_service.py:197",
                exc_info=True,
            )
            db.session.rollback()
            return False, str(e)
    ...
    def fulfill_reservation(reservation_id):
        ...
        try:
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/reservation_service.py:234",
                exc_info=True,
            )
            db.session.rollback()
            return False, str(e)
