...
def process_inventory_adjustment(
    ...
    try:
        ...
        logger.warning(
            "Suppressed exception fallback at app/services/inventory_adjustment/_core.py:114",
            exc_info=True,
        )
        qty_float = 0.0
    ...
    try:
        ...
        if unit and item.unit and unit != item.unit:
            try:
                ...
                logger.warning(
                    "Suppressed exception fallback at app/services/inventory_adjustment/_core.py:151",
                    exc_info=True,
                )
                db.session.rollback()
        ...
        try:
            ...
            if is_additive:
                ...
                try:
                    ...
                    logger.warning(
                        "Suppressed exception fallback at app/services/inventory_adjustment/_core.py:327",
                        exc_info=True,
                    )
                    current = 0.0
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/inventory_adjustment/_core.py:331",
                exc_info=True,
            )
            pass
        ...
        logger.warning(
            "Suppressed exception fallback at app/services/inventory_adjustment/_core.py:404",
            exc_info=True,
        )
        db.session.rollback()
        logger.error(
