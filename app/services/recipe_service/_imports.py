...
def _resolve_import_name(
    ...
    if global_item_id:
        try:
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/recipe_service/_imports.py:32",
                exc_info=True,
            )
            pass
    ...
    *,
    ...
    if global_item_id:
        try:
            ...
            logger.warning(
                "Suppressed exception fallback at app/services/recipe_service/_imports.py:115",
                exc_info=True,
            )
            global_item = None
