...
class RecipeStatisticsService:
    ...
    def increment_batch_completed(recipe_id: int, organization_id: int):
        ...
        try:
            ...
            total_batches = recipe_stats.total_batches_completed + recipe_stats.total_batches_failed
            if total_batches > 0:
                recipe_stats.success_rate_percentage = (recipe_stats.total_batches_completed / total_batches) * 100
