...
class BaseConfig:
    ...
    BOT_TRAP_REDIS_ENABLED = SETTINGS.get("BOT_TRAP_REDIS_ENABLED", True)
    BOT_TRAP_REDIS_PREFIX = SETTINGS.get("BOT_TRAP_REDIS_PREFIX", "bottrap:v1")
    BOT_TRAP_LOG_HITS_TO_DB = SETTINGS.get("BOT_TRAP_LOG_HITS_TO_DB", False)
    BOT_TRAP_DB_MAX_HIT_ROWS = SETTINGS.get("BOT_TRAP_DB_MAX_HIT_ROWS", 5000)
    BOT_TRAP_DB_HIT_TRIM_BATCH = SETTINGS.get("BOT_TRAP_DB_HIT_TRIM_BATCH", 500)
    ...
    CAPTCHA_PROVIDER = (SETTINGS.get("CAPTCHA_PROVIDER", "none") or "none").lower()
    CAPTCHA_TURNSTILE_SITE_KEY = SETTINGS.get("CAPTCHA_TURNSTILE_SITE_KEY")
    CAPTCHA_TURNSTILE_SECRET_KEY = SETTINGS.get("CAPTCHA_TURNSTILE_SECRET_KEY")
    CAPTCHA_VERIFY_TIMEOUT_SECONDS = SETTINGS.get("CAPTCHA_VERIFY_TIMEOUT_SECONDS", 5)
    ...
    SIGNUP_PUBLIC_ALLOW_LIVE_PRICING_NETWORK = SETTINGS.get(
        "SIGNUP_PUBLIC_ALLOW_LIVE_PRICING_NETWORK", True
    )
    ...
    GOOGLE_ADS_PURCHASE_CONVERSION_LABEL = SETTINGS.get(
        "GOOGLE_ADS_PURCHASE_CONVERSION_LABEL"
    )
    POSTHOG_PROJECT_API_KEY = SETTINGS.get("POSTHOG_PROJECT_API_KEY")
    POSTHOG_HOST = SETTINGS.get("POSTHOG_HOST") or "[REDACTED]"
