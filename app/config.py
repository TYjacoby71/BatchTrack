...
def _resolve_bot_trap_policy(reader: EnvReader) -> dict[str, Any]:
    ...
    if (
        resolved["BOT_TRAP_IP_BLOCK_MAX_SECONDS"]
        < resolved["BOT_TRAP_IP_BLOCK_SECONDS"]
    ):
        reader.warn(
...
class BaseConfig:
    ...
    BOT_TRAP_STRIKE_WINDOW_SECONDS = _BOT_TRAP_POLICY["BOT_TRAP_STRIKE_WINDOW_SECONDS"]
    ...
    BOT_TRAP_PENALTY_RESET_SECONDS = _BOT_TRAP_POLICY["BOT_TRAP_PENALTY_RESET_SECONDS"]
