...
```
The code has been modified to include the is_organization_owner and has_permission template functions to properly handle developer customer support mode, granting developers access to organization-level features and permissions when mimicking an organization.
```
