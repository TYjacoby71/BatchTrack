...
"""
Unit seeder for BatchTrack application.
Seeds standard measurement units used in recipes and inventory.
"""
...
def seed_units():
    ...
    units = [
        ...
        {"name": "ton", "symbol": "ton", "unit_type": "weight", "base_unit": "gram", "conversion_factor": 1000000.0, "is_custom": False, "is_mapped": True, "created_by": None},
        ...
        {"name": "dram", "symbol": "dr", "unit_type": "volume", "base_unit": "ml", "conversion_factor": 3.69669, "is_custom": False, "is_mapped": True, "created_by": None},
        ...
        # Area Units
        {"name": "sqcm", "symbol": "cm^2", "unit_type": "area", "base_unit": "sqcm", "conversion_factor": 1.0, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "sqm", "symbol": "m^2", "unit_type": "area", "base_unit": "sqcm", "conversion_factor": 10000.0, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "sqinch", "symbol": "in^2", "unit_type": "area", "base_unit": "sqcm", "conversion_factor": 6.4516, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "sqft", "symbol": "ft^2", "unit_type": "area", "base_unit": "sqcm", "conversion_factor": 929.03, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "sqyard", "symbol": "yd^2", "unit_type": "area", "base_unit": "sqcm", "conversion_factor": 8361.27, "is_custom": False, "is_mapped": True, "created_by": None},
        ...
        # Cubic Volume Units
        {"name": "cubicinch", "symbol": "in^3", "unit_type": "volume", "base_unit": "ml", "conversion_factor": 16.3871, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "cubicfoot", "symbol": "ft^3", "unit_type": "volume", "base_unit": "ml", "conversion_factor": 28316.8, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "cubicyard", "symbol": "yd^3", "unit_type": "volume", "base_unit": "ml", "conversion_factor": 764555.0, "is_custom": False, "is_mapped": True, "created_by": None},
        ...
        {"name": "pack", "symbol": "pack", "unit_type": "count", "base_unit": "count", "conversion_factor": 1.0, "is_custom": False, "is_mapped": True, "created_by": None},
        ...
        # Time Units
        {"name": "second", "symbol": "sec", "unit_type": "time", "base_unit": "second", "conversion_factor": 1.0, "is_custom": False, "is_mapped": True, "created_by": None},
        ...
        {"name": "month", "symbol": "mo", "unit_type": "time", "base_unit": "second", "conversion_factor": 2629746.0, "is_custom": False, "is_mapped": True, "created_by": None},
        {"name": "year", "symbol": "yr", "unit_type": "time", "base_unit": "second", "conversion_factor": 31556952.0, "is_custom": False, "is_mapped": True, "created_by": None},
    ]
    ...
    for unit_data in units:
        ...
        if not existing_unit:
            print(f"   Adding unit: {unit_data['name']} ({unit_data['symbol']})")
            unit = Unit(**unit_data)
            db.session.add(unit)
            added_count += 1
