    ...
    for filename in selected_files:
        ...
        for item_data in category_data.get('items', []):
            ...
            if existing_item:
                ...
                global_item.is_active_ingredient = item_data.get('is_active_ingredient', False)
                ...
                global_item.moisture_content_percent = item_data.get('moisture_content_percent')
                ...
                global_item.brewing_diastatic_power_lintner = item_data.get('brewing_diastatic_power_lintner')
