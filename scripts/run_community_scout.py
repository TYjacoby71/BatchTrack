...
@click.option('--no-primary', is_flag=True, help='Require replica availability before running.')
def main(batch_size: int, page_size: int, max_batches: int | None, no_primary: bool):
