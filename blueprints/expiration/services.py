...
from app.models import db, InventoryItem, InventoryHistory, ProductInventory, ProductInventoryHistory, Batch
...
from app.models import db, InventoryHistory, InventoryItem, ProductInventory, Batch

from datetime import datetime, timedelta
from typing import List, Dict, Optional
from app.models import db, InventoryItem, InventoryHistory, ProductInventory, Batch
from sqlalchemy import and_
